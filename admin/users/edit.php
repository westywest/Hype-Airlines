    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <p>Anda sedang mengedit data pengguna. Jangan lupa klik <b>tombol save</b> untuk menyimpan perubahan.</p>
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama" required value="<?php echo $name ?>">
                            </div>
                            <div class="mb-3">
