...
<body>
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO planes (code, type) VALUES ('$code', '$type');";
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Membuat Data Pesawat</li>
                    </ol>
                </nav>
                <h1 class="h2">Membuat Data Pesawat</h1>
                <p>Anda sedang menambah data pesawat baru.</p>
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" placeholder="Code Pesawat" required>
                            </div>
                            <div class="mb-3">
                                <label for="type" class="form-label">Type</label>
                                <input type="text" class="form-control" id="type" name="type" placeholder="Type Pesawat" required>
                            </div>
